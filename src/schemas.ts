...
export const ConfigSchema = z.object({
  ...
  privacy: z.object({ syntheticData: z.boolean().default(true), allowProduction: z.boolean().default(false), scanArtifacts: z.boolean().default(true) }).default({ syntheticData: true, allowProduction: false, scanArtifacts: true }),
  ...
  }).default({ provider: 'none', elevenlabs: { modelId: 'eleven_multilingual_v2', outputFormat: 'mp3_44100_128', apiKeyEnv: 'ELEVENLABS_API_KEY' } }),
